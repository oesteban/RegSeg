...
\newacronym{tbss}{TBSS}{tract-based spatial statistics}

\newacronym[first={AMICO \cite[accelerated microstructure imaging via convex optimization,][]{daducci_accelerated_2015}}]%
{amico}{AMICO}{accelerated microstructure imaging via convex optimization}
