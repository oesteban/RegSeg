...
\cite{gorthi_active_2011} review the application of joint segmentation and registration in atlas-based
  segmentation, and propose a multiphase level set function to register several active contours.
