...
\begin{figure*}
  ...
  \Regseg showed high accuracy, as it demonstrates the almost exact location of the registered
  ...
  Partial volume effect turns segmentation of the sulci a challenging problem with voxel-wise
    clustering methods, but it is successfully segmented with \regseg{}.
...
All the statistical tests evidenced that error distributions obtained with \regseg{} and
  ...
  \autoref{fig:results_real} we observed that errors were always larger for \gls*{t2b}.
