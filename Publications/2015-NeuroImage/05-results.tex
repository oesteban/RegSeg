    ...
    \resizebox{\textwidth}{!}{%
      \begin{tikzpicture}
        \node[inner sep=10pt, draw=black!40](fig03b) at (0,7.9)
          {\hspace*{20pt}\includegraphics[width=\linewidth]{figure05A}};
        \node[inner sep=10pt, draw=black!40](fig03c) at (0,0)
          {\hspace*{20pt}\includegraphics[width=\linewidth]{figure05B}};
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tikzpicture}
        \node[inner sep=15pt, draw=black!40](fig05a) at (0,11)
          {\hspace*{20pt}\includegraphics[width=\linewidth]{figure06A}};
        \node[inner sep=15pt, draw=black!40](fig05b) at (0,0)
          {\hspace*{20pt}\includegraphics[width=\linewidth]{figure06B}};
        % \node[inner sep=5pt, draw=black!40](fig03c) at (0,0)
        %   {\includegraphics[width=\linewidth]{figure03-c}};
