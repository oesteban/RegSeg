...
In the presented application to segment \gls*{dmri}, we propose a bivariate 
  target-volume comprehending the \gls*{fa} and \gls*{adc} maps.
The active-contours are without edges since the \gls*{fa} and \gls*{adc} maps
  do not present steep image gradients (edges) but anatomy can be identified
