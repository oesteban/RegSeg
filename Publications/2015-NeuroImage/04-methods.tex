...
\begin{figure}
  ...
  In this figure, the $\bar{s}_1$ derivated from \autoref{eq:regseg-shape_gradient_disc2} is 
...
Panel C, after \regseg{} registration, shows how the covariance matrices $\boldsymbol{\Sigma}_l$
  ...
  to the theoretical situation presented in panel B.}\label{fig:regseg-model}
\end{figure*}
