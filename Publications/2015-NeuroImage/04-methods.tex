...
\begin{figure}
  ...
  \caption{The {\color{revcolor} interfacing surfaces $\Gamma_m$ between the competing \glspl{roi} $\Omega_l$,
  play the role of active contours which drive the registration process.}
  They evolve iteratively {\color{revcolor} along the normal $\hat{\mathbf{n}}_i$ of the surface} at each vertex
  ...
  {\color{revcolor} The computation of shape-gradients is developed in \ref{app:shape_gradients}.}
