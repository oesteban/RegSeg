...
\caption{The evaluation of \regseg{} on phantom data is performed with the presented instrumental workflow:
  ...
  5) The \regseg{} tool is run, using the warped test images as multispectral moving-image and $\gammaset_R$ as shape-priors;
...
\caption{Experimental workflow to process real data from the \acrfull*{hcp}.
