...
\begin{figure}
  ...
  They evolve iteratively {\color{blue} along the normal $\hat{\mathbf{n}}_i$ of the surface} at each vertex
...
Therefore, the deformation field is nonzero only in the \revcomment[R\#3-C.23]{\acrfull*{pe}} axis,
  and \revcomment[R\#1-C3]{reproduces a} real \gls*{epi} distortion.
