...
\title{Simultaneous segmentation and distortion correction on diffusion MRI data using shape priors}
%%
\titlerunning{Simultaneous segmentation and distortion correction on dMRI}  % abbreviated title (for running head)
