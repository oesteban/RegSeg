...
The target \gls{dwi} data is characterized by its distortions and its
...
intended, the \gls{dwi} raw data has to be processed in order to
...
findings, the proposed energy model adapts to the \gls{fa}~\eqref{eq:fa} 
and \gls{md}~\eqref{eq:md} for their properties. 
