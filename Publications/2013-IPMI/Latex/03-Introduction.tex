...
subject (e.g. T1 and/or T2 weighted acquisitions). %Conversely, this problem is resolved with non-linear registration of a structural \ac{mri} of the subject to the \ac{dwi} data. 
